...
<html lang="en">
    <head>
        ...
        <title>Inspire and Monitor</title>
        <!-- Favicon-->
...
<!--                 <div class="text-center mt-4">
        ...
        <footer class="footer text-center footer-color">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">About Inspire & Monitor</h4>
                        <p class="lead mb-0">
                            Place your text here
        ...
        <!-- Portfolio Modals-->
        <!-- Portfolio Modal 1-->
        <div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" aria-labelledby="portfolioModal" aria-hidden="true">
